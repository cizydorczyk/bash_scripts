...
assemblies_dir="/home/conrad/hinfluenzae/i35_gwas/nextpolish/assembly_symlinks/"
fastq_dir="/home/conrad/hinfluenzae/i35_gwas/nextpolish/fastq_symlinks/"
isolate_list="/home/conrad/hinfluenzae/i25_public_genomes/potts_fastq/potts_matched_st_isolate_list.txt"
...
do
  assembly="${assemblies_dir}${isolate}_unpolished_assembly.fasta"
  ...
  do
    ...
    python ~/software/NextPolish/lib/nextpolish1.py -g ${assembly} -t 2 -p ${threads} -s ${isolate}.sgs.sort.bam -ploidy 1 > ${isolate}_polished_assembly.fasta
    assembly=${isolate}_polished_assembly.fasta
...
# polished genome is ${isolate}_polished_assembly.fasta
